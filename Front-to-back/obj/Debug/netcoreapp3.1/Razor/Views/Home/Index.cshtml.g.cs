#pragma checksum "C:\Users\HP\Desktop\p130\Front-to-back\Front-to-back\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f9eceb0c4a57e470fdb5e530945e54b5a99c1b0e"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"f9eceb0c4a57e470fdb5e530945e54b5a99c1b0e", @"/Views/Home/Index.cshtml")]
    ...
    public class Views_Home_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "C:\Users\HP\Desktop\p130\Front-to-back\Front-to-back\Views\Home\Index.cshtml"
                ...
                <div class=""carousel-item active"">
                    ...
                    <div class=""py-5 row d-flex align-items-center"">
                        <div class=""banner-content col-lg-8 col-8 offset-2 m-lg-auto text-left py-5 pb-5"">
                            <h1 class=""banner-heading h1 text-secondary display-3 mb-0 pb-5 mx-0 px-0 light-");
            WriteLiteral(@"300 typo-space-line"">
                ...
                <div class=""carousel-item"">
                    ...
                    <div class=""py-5 row d-flex align-items-center"">
                        <div class=""banner-content col-lg-8 col-8 offset-2 m-lg-auto text-left py-5 pb-5"">
                            ...
                            <a class=""ba");
            WriteLiteral(@"nner-button btn rounded-pill btn-outline-primary btn-lg px-4"" href=""#"" role=""button"">Get Started</a>
                        </div>
                    </div>
...
<section class=""service-wrapper py-3"">
    <div class=""container-fluid pb-3"">
        <div class=""row"">
            <h2 class=""h2 text-center col-12 py-5 semi-");
            WriteLiteral(@"bold-600"">Services</h2>
        ...
        <div class=""col-md-12"">
            <ul class=""nav d-flex justify-content-center"">
                <li class=""nav-item mx-lg-4"">
                    <a class=""filter-btn nav-link btn-outline-primary active");
            WriteLiteral(@" shadow rounded-pill text-light px-4 light-300"" href=""#"" data-filter="".project"">All</a>
                </li>
                <li class=""nav-item mx-lg-4"">
...
<section class=""container overflow-hidden py-5"">
    <div class=""row gx-5 gx-sm-3 gx-lg-5 gy-lg-5 gy-3 pb-3 projects"">
        ...
        <div class=""col-xl-3 col-md-4 col-sm-6 project ui graphic"">
            <a href=""#"" class=""service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0"">
                <img class=""card-im");
            WriteLiteral(@"g"" src=""./assets/img/services-02.jpg"" alt=""Card image"">
                <div class=""service-work-vertical card-img-overlay d-flex align-items-end"">
                    <div class=""service-work-content text-left text-light"">
        ...
        <div class=""col-xl-3 col-md-4 col-sm-6 project branding"">
            <a href=""#"" class=""service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0"">
                ...
                <div class=""service-work-vertical card-img-overlay d-flex align-items-end"">
                    <div class=""service-work-content text-left text");
            WriteLiteral(@"-light"">
        ...
        <!-- Start Recent Work -->
        <div class=""col-xl-3 col-md-4 col-sm-6 project b");
            WriteLiteral(@"randing"">
            <a href=""#"" class=""service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0"">
        ...
        <div class=""col-xl-3 col-md-4 col-sm-6 project ui graphic branding"">
            <a href=""#"" class=""service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0"">
                ...
                <div class=""service-work-vertical card-img-overlay d-flex align-items-end"">
                    <div class=""service-work-content text-left text-light"">
                        <span class=""btn ");
            WriteLiteral(@"btn-outline-light rounded-pill mb-lg-3 px-lg-4 light-300"">Branding</span>
                        <p class=""card-text"">Lorem ipsum dolor sit amet, consectetur adipisicing</p>
                    </div>
                </div>
            </a>
    ...
    <div class=""container py-5"">
        <div class=""row d-flex justify-content-center text-center"">
            ...
            <div class=""col-lg-3 col-12 pt-4"">
                <a href=""#"" class=""btn btn-primary rounded-pill btn-block shadow px-4");
            WriteLiteral(@" py-2"">View Our Work</a>
            </div>
        </div>
    </div>
</section>
...
<section class=""py-5 mb-5"">
    <div class=""container"">
        ...
        <div class=""row gy-5 g-lg-5 mb-4"">
                ...
                <a href=""#"" class=""recent-work card border-0 shadow-lg overflow-hidden"">
                    ...
                    <div class=""recent-work-vertical card-img-overlay d-flex align-items-end"">
                        <div class=""recent-work-content text-start mb-3 ml-3 text-dark"">
                            ...
                            <p class=""card-text"">Ullamco laboris nisi ");
            WriteLiteral(@"ut aliquip ex</p>
                        </div>
                    </div>
                </a>
            </div><!-- End Recent Work -->
            ...
            <div class=""col-md-4 mb-3"">
                <a href=""#"" cla");
            WriteLiteral(@"ss=""recent-work card border-0 shadow-lg overflow-hidden"">
